(function (App) {
    ...
    App.Quest.Common.Bath.Next=function(){
        ...
        if (App.GetItemNumber("Re shui")<3){
       ...
       App.Commands([
        ...
        App.NewCommand("do","add shechuang zi;add digu pi;add sheng gancao;add re shui;add re shui;add re shui;bath"),
